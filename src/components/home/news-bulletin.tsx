    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <h3 className="text-3xl font-black uppercase italic tracking-tighter">{FESTIVAL.name} News</h3>
        </div>
      ...
      <Card className="bg-card/30 backdrop-blur-3xl border-white/5 rounded-[2rem] overflow-hidden">
        <CardContent className="p-8 text-center">
          <p className="font-bold text-lg leading-snug text-muted-foreground/60 italic">
            Live festival updates will appear here once {FESTIVAL.name} begins.
          </p>
        </CardContent>
      </Card>
    </div>
