...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        // 2. Build sziget artist ID → Spotify artist ID map
        ...
        await Promise.all(
            artistIds.map(async (artistId) => {
                ...
                const tracksRes = await fetch(
                    `https://api.spotify.com/v1/artists/${spotifyArtistId}/top-tracks?market=HU`,
                    { headers }
                );
        ...
        const createRes = await fetch(`https://api.spotify.com/v1/users/${userId}/playlists`, {
            ...
            headers,
            body: JSON.stringify({
                name: 'My Sziget 2026 Lineup',
                description: 'Generated by Sziget Insider — your personal festival playlist.',
                public: false,
            }),
        });
