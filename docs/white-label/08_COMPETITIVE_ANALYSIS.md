...
| Passport / XP gamification | ❌ | ✅ |
| Serendipity / random artist discovery | ❌ | ✅ |
| Survival guide (practical tips) | ❌ | ✅ |
| Home screen widget (rank, XP, favorites) | Possibly | ✅ |
...
- **Risk**: Small audience = smaller engagement volume. But higher fan loyalty (metalheads are dedicated) → passport/XP gamification likely to resonate strongly.

### Nova Rock — Challenger
...
### Frequency — Challenger (FM4 Angle)
...
| **Engagement** | | | |
| Passport / stamp collection | ✅ | ❌ | Festival-attendance gamification |
| XP / rank progression | ✅ | ❌ | "Island Legend" etc. |
| Challenges (e.g., see all headliners) | ✅ | ❌ | |
| Highlights wrap (post-festival) | ✅ | ❌ | Share your festival recap |
...
- Measure: DAU, session length, Spotify matches triggered, passport XP earned
