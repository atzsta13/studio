...
export interface FestivalFeatureFlags {
  ...
  dailyChallenges: boolean     // 24h rotating goals for XP
  leaderboard: boolean         // Global XP ranking
  achievements: boolean        // Permanent medals/badges
  ...
  ecoWarrior: boolean          // XP for sustainability
