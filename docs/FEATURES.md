...
| `achievements` | Gamification | ✅ | 📱 | Modular medal/badge engine |
| `dailyChallenges` | Gamification | ✅ | 📱 | 24h rotating XP goals |
| `leaderboard` | Gamification | ✅ | 📱 | Mocked global XP ranking |
| `ecoWarrior` | Gamification | ✅ | 📱 | Sustainability XP system |
| `stickerBook` | Gamification | ✅ | 📱 | Digital stamp collection logic |
