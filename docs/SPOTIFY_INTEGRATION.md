...
### 2. SpotifyViewModel generates PKCE challenge
...
### 3. Auth URL built with code_challenge
...
1. App initiates: `https://spotify.com/authorize?code_challenge=abc...`
...
val challenge = generateCodeChallenge(verifier)  // SHA256 + Base64
...
1. User taps "SYNC SPOTIFY LIBRARY"
   ↓
2. SpotifyViewModel generates verifier + challenge
   ↓
