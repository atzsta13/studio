...
import org.openfestivalhub.ui.theme.AcidYellow
import org.openfestivalhub.ui.theme.OpenFestivalHubTheme

import androidx.compose.runtime.*
import androidx.compose.ui.graphics.Color
import androidx.compose.ui.graphics.toArgb
import org.openfestivalhub.data.config.FestivalConfig
import org.openfestivalhub.ui.navigation.AppNavigation
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Thread.setDefaultUncaughtExceptionHandler { _, exception ->
            Log.e("OpenFestivalHub", "Uncaught exception", exception)
