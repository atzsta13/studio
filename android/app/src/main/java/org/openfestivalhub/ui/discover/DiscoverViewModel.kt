...
class DiscoverViewModel(
    ...
    private val localScoutRepository = context?.let { org.openfestivalhub.data.repository.LocalScoutRepository(it) }
    ...
    private suspend fun findNearestStage(userLat: Double, userLng: Double): String? {
        val ctx = context ?: return null
        val poiRepo = org.openfestivalhub.data.repository.POIRepository(ctx)
